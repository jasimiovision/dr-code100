...
export class ReportDataService {
  ...
  async generateReportPreview(vcr: ViewContainerRef){
    ...
    newWindow.document.write(`<table class="report-container">
                        ...
                        </td></tr></tbody> <tfoot><tr> <td><div class="footer-space">&nbsp;</div></td></tr></tfoot></table><div id="footer"><table style="width:100%"><tbody><tr><td style="width:33%;">Report No.:</td><td style="width:33%;">Rev.:</td><td style="width:33%;" id="page-number">Page:</td></tr><tr><td>Method Statement Doc. No.:PRPL-23</td></tr></tbody></table></div> `)
